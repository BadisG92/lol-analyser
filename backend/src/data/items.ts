...
export const ITEMS: ItemRef[] = [
  ...
  // ── AD / Lethality ──
  { name: "Youmuu's Ghostblade", gold: 2800, category: "ad_lethality", visual: "ghostly purple/blue katana" },
  ...
  { name: "Hubris", gold: 3000, category: "ad_lethality", visual: "golden laurel wreath" },
  ...
  { name: "Shadowflame", gold: 3000, category: "ap", visual: "dark purple orb wreathed in shadow flames" },
  ...
  { name: "Luden's Companion", gold: 2900, category: "ap", visual: "blue arcane orb with spark companion" },
  ...
  { name: "Echoes of Helia", gold: 2200, category: "support", visual: "ghostly green spectral chalice" },
